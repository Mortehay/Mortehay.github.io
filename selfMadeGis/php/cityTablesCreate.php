...
$tables[9] = 'CREATE TABLE IF NOT EXISTS '.$selectedCity.'.'.$selectedCity.'_ctv_topology(id serial,cubic_city character varying(100),cubic_street character varying(100),cubic_house character varying(100),cubic_flat character varying(100),cubic_code character varying(100),cubic_name character varying(100),cubic_pgs_addr character varying(100),cubic_ou_op_addr character varying(100),cubic_ou_code character varying(100), cubic_ou_name character varying(100), cubic_ou_street character varying(100), cubic_ou_house character varying(100), cubic_date_reg character varying(100),cubic_coment character varying(100),cubic_uname character varying(100),cubic_net_type character varying(100),cubic_house_id character varying(100),equipment_geom geometry,mother_equipment_geom geometry,topology_line_geom geometry, link text, archive_link text, flats text, equipment_type varchar(100), equipment_model varchar(100), equipment_legality varchar(100), equipment_project varchar(100), she_num varchar(100), district varchar(100), microdistrict varchar(100), equipment_notes varchar(100));';
//-----------------------------------------------------------------------------------------------------------------------------
