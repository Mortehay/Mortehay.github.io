...
//ini_set('display_errors', 1);
	...
	$linkArchive = "'".'<a href='.'"'.'http://77.121.192.25/qgis-ck/tmp/archive/'.$selectedCity.'/cc/'."'".'||tmp_x.table_id||'."'".'" target="_blank">посилання на архів</a>'."'";
