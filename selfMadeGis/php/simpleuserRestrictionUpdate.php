...
/* //echo $restriction;
  ...
  $host        = "host=127.0.0.1";
          ...
          //$sql_new .= 'REVOKE ALL ON DATABASE postgres FROM public; GRANT CONNECT ON DATABASE postgres TO simplereader;GRANT SELECT ON ALL TABLES IN SCHEMA '.$city_array[$key].' TO simplereader;';
			}
			//echo $sql;
