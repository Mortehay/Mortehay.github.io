              ...
              foreach($files as $file) {
                ...
                if ($str_file !== '.' && $str_file !== '..') {
                      ...
                      if ($str_file == $selectedCity."_ctv_topology.csv") {
                       ...
                       $archive_link =  "Update  ".$selectedCity.".".$selectedCity."_ctv_topology set archive_link = CASE  WHEN cubic_name like '%Блок питания%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/supply/||cubic_code||/' target='_blank'>посилання на архів</a>'  end;";
                      echo $archive_link;
                      //$archive_link =  "Update  ".$selectedCity.".".$selectedCity."_ctv_topology set archive_link = CASE  WHEN cubic_name like '%Блок питания%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/supply/''||cubic_code||'/' target='_blank'>посилання на архів</a>'  WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/camp/'||cubic_code||'/' target='_blank'>посилання на архів</a>'  WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/mdod/'||cubic_code||'/' target='_blank'>посилання на архів</a>'   WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/cmamp/'||cubic_code||'/' target='_blank'>посилання на архів</a>'   WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/nod/'||cubic_code||'/' target='_blank'>посилання на архів</a>'  WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/op/'||cubic_code||'/' target='_blank'>посилання на архів</a>'  WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/cmtap/'||cubic_code||'/' target='_blank'>посилання на архів</a>'  WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/ot/'||cubic_code||'/' target='_blank'>посилання на архів</a>'  WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/revch/'||cubic_code||'/' target='_blank'>посилання на архів</a>'   WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/brm/'||cubic_code||'/' target='_blank'>посилання на архів</a>'  WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/cc/'||cubic_code||'/' target='_blank'>посилання на архів</a>' WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/mnod/'||cubic_code||'/' target='_blank'>посилання на архів</a>' WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/ctap/'||cubic_code||'/' target='_blank'>посилання на архів</a>' WHEN cubic_name like '%Домовой узел%' then '<a href='http://77.121.192.25/qgis-ck/tmp/archive/".$selectedCity."/topology/csamp/'||cubic_code||'/' target='_blank'>посилання на архів</a>' end;";
                      }
                  }
                }
              }
