...
var simpleWmsSearch = {
  ...
  gridColumns: [
    {header: 'Street', dataIndex: 'cubic_street', menuDisabled: 'true', renderer: customURLFormatter},
    {header: 'House', dataIndex: 'cubic_house', menuDisabled: 'true', renderer: customURLFormatter}
  ],
